    ...
    public partial class _1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisingContracts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletionOrderDate = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSelleable = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Qualifications = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersBusinesses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteProductsByUser_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisingContracts_BusinessId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AssosiatedBusinessId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteProductsByUser_UserId",
                table: "FavoriteProductsByUser",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersBusinesses_UserId",
                table: "UsersBusinesses",
                column: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AdvertisingContracts_Businesses_BusinessId",
                table: "AdvertisingContracts",
                column: "BusinessId",
                principalTable: "Businesses",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Businesses_AssosiatedBusinessId",
                table: "AspNetUsers",
                column: "AssosiatedBusinessId",
                principalTable: "Businesses",
                principalColumn: "Id");
